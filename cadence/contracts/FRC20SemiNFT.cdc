        ...
        fun resolveView(_ view: Type): AnyStruct? {
            ...
            if colViews.contains(view) {
                ...
                case Type<MetadataViews.Display>():
                    ...
                    let tickNameSizeTitle = 240 + (10 - tick.length > 0 ? 10 - tick.length : 0) * 12
                    ...
                    var svgStr = "data:image/svg+xml;utf8,"
                        .concat("<svg viewBox='0 0 2048 2048' style='shape-rendering: crispedges;' xmlns='http://www.w3.org/2000/svg'>")
